angular.module('mongooseResource', []).factory('mongooseResource', ['MONGOOSE_CONFIG','$http', '$q', function (MONGOOSE_CONFIG, $http, $q) {

    function mongooseResourceFactory(collectionName) {

        var url = MONGOOSE_CONFIG.baseUrl + collectionName;
        var defaultParams = {};
    ...
    return mongooseResourceFactory;
}]);
